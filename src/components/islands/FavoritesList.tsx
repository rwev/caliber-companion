  ...
  return (
    <section class="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {favorites.map(cal => (
          <div key={cal.slug} class="group relative border border-surface-border bg-surface transition-colors hover:border-accent/40 hover:bg-surface-raised">
            <a href={`${basePath}/calibers/${cal.slug}`} class="block p-4">
              <div class="flex items-start justify-between gap-3">
                ...
                <span class="shrink-0 border border-surface-border px-2 py-0.5 font-mono text-xs tracking-wider uppercase text-text-muted">
